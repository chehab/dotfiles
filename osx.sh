...
sudo scutil --set ComputerName "Chehab-MBP"
sudo scutil --set HostName "Chehab-MBP"
sudo scutil --set LocalHostName "Chehab-MBP"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Chehab-MBP"
